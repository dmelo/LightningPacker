...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
	...
	$view->headScript()->appendFile('http://lighteningpacker.localhost/packit.php?type=js&obj[]=http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js&obj[]=http://autobahn.tablesorter.com/jquery.tablesorter.min.js');
