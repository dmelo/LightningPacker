...
class IndexController extends Zend_Controller_Action
{
	...
	$this->view->table = array(
		...
		array('expiration', 'Time for which the cache must be kept, in seconds. This parameter is optional and the default value is 172800, which is the equivalent to two days.', '3600'),
	    );
